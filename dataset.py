...
if __name__ == "__main__":
    ...
    for i, batch in enumerate(train_loader):
        ...
        print("mel_padded:", names_shape(
            ["N", "TIME", "FREQ"], mel_padded.shape))
        print("mel_lengths:", names_shape(["N"], mel_lengths.shape))
        print("stop_token_padded:", names_shape(
            ["N", "TIME"], stop_token_padded.shape))
...
#             wav_path, normalize=True)

#         # Check if sample rate needs to be resampled
#         if original_sample_rate != hp.sr:
#             resample_transform = Resample(original_sample_rate, hp.sr)
...
#         # print(f"Processed item {index} - {wav_id}")
...
#     # # Add this line for debugging
#     # print("Debugging point - batch processed successfully")
...
#     print("DataLoader constructed successfully")
